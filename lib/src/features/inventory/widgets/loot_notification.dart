...
class _LootNotificationState extends State<LootNotification>
  ...
  Widget build(BuildContext context) {
    final accent = widget.goldAmount != null
        ? SoloLevelingColors.warning
        : ItemRarityStyle.colorFromLabel(widget.itemRarity);
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(
                color: accent.withValues(alpha: _glowAnimation.value * 0.5),
                blurRadius: 30,
                spreadRadius: 4,
              ),
            ],
            ...
            children: [
              ...
              Container(
                ...
                child: widget.goldAmount != null
                    ...
                    : Icon(Icons.inventory_2, color: accent, size: 28),
              ),
